...
if __name__ == "__main__":
    port = int(os.getenv("PORT", 8000))  # Получаем порт из переменной окружения или по умолчанию 8000
    uvicorn.run(app, host="0.0.0.0", port=port)  # Запускаем сервер на найденном порту
